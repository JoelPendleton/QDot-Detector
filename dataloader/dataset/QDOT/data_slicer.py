...
def save_to_xml(save_path, im_height, im_width, objects_axis, label_name):
    ...
    folder_name = doc.createTextNode('QDOT')
    ...
    database.appendChild(doc.createTextNode('The QDOT Database'))
    ...
    name_o.appendChild(doc.createTextNode('Joel'))
