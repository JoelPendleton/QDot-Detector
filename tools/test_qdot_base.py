...
def parse_args():
    ...
    parser.add_argument('--img_dir', dest='img_dir',
                        help='images path',
                        default='/workspace/qdot-detector/dataloader/dataset/QDOT/test/images', type=str)
    ...
    parser.add_argument('--test_annotation_path', dest='test_annotation_path',
                        ...
                        default='/workspace/qdot-detector/dataloader/dataset/QDOT/test/labeltxt', type=str)
